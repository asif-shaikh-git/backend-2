...
export const logoutUser = asyncHandler(async (req, res) => {
  ...
  // store all sessions except the one being logged out-
  // - (identified by refresh token from cookie):
  ...
  for (const session of user.refreshTokens) {
    ...
    const isMatch = await bcrypt.compare(refreshTokenFromCookie, session.token);
